...
<body>
   <header>
      <nav class="header navbar navbar-expand-lg navbar-dark fixed-top" style="margin-bottom: 0px;">
...
<%--                      <span class="text">${login.member_id } 님</span> --%>
                     ...
                     <span id="user_id" >안녕하세요. ${user_id }님</span>
                     <span>
                     <button class="mypagebutton btn " onclick="location.href='mypage.do'">마이페이지</button>
                     <button class="logoutbutton btn " onclick="location.href='${pageContext.request.contextPath}/logout'">로그아웃</button>
                     </span>
                  </div>
               </sec:authorize>
         </div>
