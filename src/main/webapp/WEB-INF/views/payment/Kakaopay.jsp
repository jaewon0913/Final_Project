	...
	<div class="container">
		...
		<table class="table">
			...
			<tr>
				<th>이름</th>
				<td>
					<input type="text" value="${memberdto.member_name }"readonly="readonly">
				</td>
			</tr>
			<tr>
				<th>아이디</th>
				<td>
					<input type="text" value="${memberdto.member_id }" readonly="readonly">
				</td>
			</tr>
			<tr>
				<th>전화번호</th>
				<td>
					<input type="text" value="${memberdto.member_phone }" readonly="readonly">
				</td>
			</tr>
			<tr>
				<th>상품명</th>
				<td>
					<input type="text" value="${dto.dosirak_title }" readonly="readonly">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<th>이름</th>
				<td>
					<input type="text" name="get_name" value="${memberdto.member_name }">
				</td>
			</tr>
			<tr>
				<th>전화번호</th>
				<td>
					<input type="text" name="get_phone" value="${memberdto.member_phone }">
				</td>
			</tr>
			<tr>
				<th>상품명</th>
				<td>
					<input type="text" name="dosirak_title" value="${dto.dosirak_title }" readonly="readonly">
				</td>
			</tr>
			<tr>
				<th>수령 장소</th>
			...
			<tr>
				<th>도시락 가격</th>
				<td>
					<input type="text" name="dosirak_price" value="${dto.dosirak_price} 원" readonly="readonly">
				</td>
			</tr>
			<tr>
				<th>배송비</th>
			...
			<tr>
				<td colspan="2" align="right">
					...
					<input type="button" value="취소" onclick="history.back()" class="btn btn-outline-light">
				</td>
			</tr>
		</table>
		<script>
			...
			$(document).ready(function() {
								...
								var queryStr = "?member_id=${memberdto.member_id}&ordernumber="
										+ ordernumber + "&choe=UTF-8";
								...
								$('#qrcode').attr('src',googleQRUrl
														+ "http://192.168.110.39:8787/mvc/qrcode.do"
												...
												function(rsp) {
													if (rsp.success) {
														...
														document.write('<form action="dosirakorderinsert.do" id="sub_form" method="post">'
																		...
																		+ '<input type="hidden" name="dosirak_delivery" value="아침">'
