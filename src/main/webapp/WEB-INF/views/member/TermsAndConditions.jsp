...
<body>
	...
	<div class="container">
		...
		<div>
			<textarea rows="20" cols="155" style="overflow: auto; resize: none;">
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
		...
		<br/>
	<textarea rows="20" cols="155" style = "resize: none;">
	ㅁ개인정보의 수집 및 이용

1. 개인정보의 수집ㆍ이용 목적
 ㅇ통합도서서비스 회원이 통합도서홈페이지 개인화서비스 이용을 목적으로 하는 경우 

2. 수집하려는 개인정보의 항목
 통합도서서비스는 회원가입 및 원활한 서비스 상담 등 기본적인 서비스 제공을 위해 아래와 같은 개인정보를 수집하고 있습니다.
 ㅇ통합도서서비스 회원번호, 웹회원 아이디, 웹회원 비밀번호, 이름, 통합도서서비스 가입도서관, 핸드폰, 이메일 

3. 개인정보의 보유 및 이용 기간
 회원 이용자의 개인정보는 회원가입일로부터 탈퇴 시까지 보유 및 이용되며, 원칙적으로 개인정보의 수집 및 이용목적이 달성되면 지체 없이 파기합니다. 따라서 우리 도서관은 정보주체의 회원탈퇴 요청 시 그 회원의 개인정보를 지체 없이 파기합니다.

4. 동의거부권 및 동의 거부에 따른 불이익
 가입자는 개인정보 수집 및 이용에 대하여 거부할 수 있는 권리가 있습니다. 단, 이에 대한 동의를 거부할 경우에는 회원가입이 불가능합니다

5. 정보주체의 권리
 통합도서서비스 회원은 자신의 개인정보 처리와 관련하여 아래와 같은 권리를 가집니다.
 ㅇ 개인정보의 처리 여부를 확인하고 개인정보에 대하여 열람(사본의 발급을 포함한다. 이하 같다)을 요구할 권리
 ㅇ 개인정보의 처리 정지, 정정·삭제 및 파기를 요구할 권리
 ㅇ 개인정보의 처리로 인하여 발생한 피해를 신속하고 공정한 절차에 따라 구제받을 권리
 이용자 분들의 개인정보 보호를 위해 「개인정보보호법」을 준수하고 있습니다.
