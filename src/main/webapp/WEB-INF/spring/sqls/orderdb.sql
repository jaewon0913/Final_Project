...
SELECT * FROM boxorder WHERE member_id='bb' AND ORDER_REGDATE BETWEEN SYSDATE-7 AND SYSDATE ORDER BY ORDER_REGDATE;
SELECT * FROM boxorder WHERE member_id='aa' AND ORDER_REGDATE BETWEEN SYSDATE-30 AND SYSDATE ORDER BY order_regdate;
SELECT * FROM boxorder WHERE member_id='bb' AND ORDER_REGDATE = sysdate ORDER BY ORDER_REGDATE;

SELECT sysdate-7 FROM dual;

SELECT * FROM boxorder WHERE member_id='aa' ORDER BY order_regdate;
